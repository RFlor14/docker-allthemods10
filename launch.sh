...
if ! [[ -f 'Server-Files-1.0.0.zip' ]]; then
	...
	curl -Lo 'Server-Files-1.0.0.zip' 'https://edge.forgecdn.net/files/5807/254/Server-Files-1.0.zip' || exit 9
...
#!https://maven.neoforged.net/releases/net/neoforged/neoforge/21.1.69/neoforge-21.1.69-installer.jar
